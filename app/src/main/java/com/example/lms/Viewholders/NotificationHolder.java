...
public class NotificationHolder extends RecyclerView.ViewHolder {
    ...
    public NotificationHolder(@NonNull View itemView, List<Notification> items, Context context, OnDeleteClickListener onDeleteClickListener) {
        super(itemView);
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position != RecyclerView.NO_POSITION) {
                    ...
                    if ("Leave Request".equals(title)) {
                        Intent intent = new Intent(context, TotalLeave.class);
                        context.startActivity(intent);
                    } else if ("Registration".equals(title)) {
                        Intent intent = new Intent(context, TotUsers.class);
                        context.startActivity(intent);
                    }
